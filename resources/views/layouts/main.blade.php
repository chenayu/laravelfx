...
<body>
    ...
    <div class="header">
		<div class="container">
            @if(session('id'))
                @if(session('smface'))
                    <img id="face" src="{{  Storage::url(session('smface'))    }}" width="50">
                @else
                    <img src=" " alt="">
                @endif
                ...
                <a @if(Route::currentRouteName() == 'space.messages') class="active" @endif href="{{ route('blog.list') }}">我的消息 
                    {{-- <span class="num-tip">20</span> --}}
                </a>
