        ...
        $.ajax({
            ...
            success:function(data) {
                ...
                $(data.data).each(function(k,v){
                    ...
                    // 1. JS里不能人换行
                    // 2. 把数据放进去
                    html += '<div class="art-list"><a target="_blank" href="/blog/'+v.id+'"><p class="title">'  +  htmlspecialchars(v.title)  +   '</p><p class="img"><img src="http://localhost:8000/uploads/'  +  v.logo +   '" alt=""></p></a><p class="btns">'  +  v.created_at  +   ' （评论：0）（阅读：'  +  v.display  +   '）（顶：'  +  v.zhan  +   '）（作者：'  +  v.user.mobile  +   '）</p></div>';
                });
                // 把HTML放到页面中
                $(".left").append( html );
                // 可以允许触发事件
